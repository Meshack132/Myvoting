...
<!DOCTYPE html PUBLIC "-//W3C//DTD HTML 5 Transitional//EN" "http://www.w3.org/TR/html5/DTD/html5-transitional.dtd">
...
function myFunction() {
    ...
    if (idNumber.length < 13) {
        alert("ID number should contain 13 characters");
        submitOK = "false";
    }
...
if(!$conn){
	...
	if(isset($_POST['Submit'])){
			...
			$Password = trim(md5($_POST['Password']));
					...
					echo "<script>alert('Youre registered');</script>";
